...
{
    const k = self._$RuntimeInterface$_;
    function S(t) {
    ...
    const P = new Map([ [ "OSLeft", "MetaLeft" ], [ "OSRight", "MetaRight" ] ]), O = {
    ...
    const D = "runtime", W = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, D), this._$_enableWindowResizeEvent$_ = !1, this._$_simulatedResizeTimerId$_ = -1, 
        ...
        _$_AddDefaultHTMLWrapEventHandlers$_(t) {
            t.addEventListener("selectstart", E), t.addEventListener("gesturehold", E), t.addEventListener("touchstart", E);
        }
        ...
        _$Attach$_() {
            ...
            window.addEventListener("keyup", (t => this._$_OnKeyEvent$_("keyup", t))), window.addEventListener("mousedown", (t => this._$_OnMouseEvent$_("mousedown", t, M))), 
            window.addEventListener("mousemove", (t => this._$_OnMouseEvent$_("mousemove", t, M))), 
            window.addEventListener("mouseup", (t => this._$_OnMouseEvent$_("mouseup", t, M))), 
            window.addEventListener("dblclick", (t => this._$_OnMouseEvent$_("dblclick", t, O))), 
            window.addEventListener("wheel", (t => this._$_OnMouseWheelEvent$_("wheel", t, O))), 
        ...
        _$_PostRuntimeEvent$_(t, s) {
            this._$PostToRuntime$_(t, s || null, R);
        }
        _$_GetWindowInnerWidth$_() {
        ...
        _$_OnWindowResize$_() {
            ...
            this._$PostToRuntime$_("window-resize", {
                ...
                innerHeight: s,
                devicePixelRatio: window.devicePixelRatio,
                isFullscreen: k._$IsDocumentFullscreen$_(),
        ...
        _$_OnFullscreenChange$_() {
            if (this._$_isExportToVideo$_) return;
            const t = k._$IsDocumentFullscreen$_();
        ...
        _$_OnMouseEvent$_(t, s, i) {
            this._$_isExportToVideo$_ || S(s) || this._$_PostToRuntimeMaybeSync$_(t, {
                button: s.button,
                buttons: s.buttons,
                clientX: s.clientX,
                clientY: s.clientY + this._$_vkTranslateYOffset$_,
        ...
        _$_OnPointerEvent$_(t, s) {
            ...
            "mouse" === s.pointerType && (i = this._$_mousePointerLastButtons$_), this._$_PostToRuntimeMaybeSync$_(t, {
                ...
                twist: s.twist || 0,
                timeStamp: s.timeStamp
            }, O), "mouse" === s.pointerType && (this._$_mousePointerLastButtons$_ = s.buttons);
        }
    ...
    k._$AddDOMHandlerClass$_(W);
}

{
    const U = "dispatchworker.js", H = "jobworker.js";
    self._$JobSchedulerDOM$_ = class {
        ...
        async _$Init$_() {
            ...
            const t = this._$_runtimeInterface$_._$GetScriptFolder$_() + U;
...
{
    function B(t) {
        return t && !t.paused && !t.ended && t.currentTime > 0;
    }
    const V = "video", j = class extends self._$DOMElementHandler$_ {
        constructor(t) {
            super(t, V), this._$SetAutoAttach$_(!1), this._$_isRuntimeInWorker$_ = !1, this._$_supportsRvfc$_ = !1, 
            this._$_postImageBitmaps$_ = !1, this._$_sequenceNumber$_ = 0, this._$_numVideos$_ = 0, 
            this._$_destroyedVideos$_ = new WeakSet, this._$AddRuntimeMessageHandler$_("init", (t => this._$_OnInit$_(t))), 
        ...
        async _$_OnInit$_(t) {
            ...
            this._$_supportsRvfc$_ = !!s.requestVideoFrameCallback && !this._$_iRuntime$_._$IsAndroidWebView$_();
        ...
        _$CreateElement$_(t, s) {
            ...
            i.crossOrigin = "anonymous", i.playsInline = !0, i.c3_imageBitmap = null, i.c3_rvfcId = -1, 
            i.c3_sequenceNumber = 0, i.c3_lastFrameSequence = -1, i.addEventListener("canplay", (() => this._$_SendPlaybackEvent$_(i, t, 0))), 
            i.addEventListener("canplaythrough", (() => this._$_SendPlaybackEvent$_(i, t, 1))), 
            i.addEventListener("ended", (() => this._$_SendPlaybackEvent$_(i, t, 2))), i.addEventListener("error", (() => this._$_SendPlaybackEvent$_(i, t, 3))), 
            i.addEventListener("loadstart", (() => this._$_SendPlaybackEvent$_(i, t, 4))), i.addEventListener("playing", (() => this._$_SendPlaybackEvent$_(i, t, 5))), 
            i.addEventListener("pause", (() => this._$_SendPlaybackEvent$_(i, t, 6))), i.addEventListener("stalled", (() => this._$_SendPlaybackEvent$_(i, t, 7)));
            const e = s.autoplay;
        ...
        _$UpdateState$_(t, s) {}
        _$DestroyElement$_(t) {
            this._$RemovePendingPlay$_(t), B(t) && t.pause(), t.src = "", this._$_numVideos$_ = Math.max(this._$_numVideos$_ - 1, 0), 
            0 === this._$_numVideos$_ && this._$_StopTicking$_(), this._$_destroyedVideos$_.add(t);
        }
        _$_OnPlay$_(t) {
        ...
        _$Tick$_() {
            ...
            for (const [s, h] of this._$_elementMap$_.entries()) {
                const n = h._$GetElement$_(), o = {
                ...
                if (this._$_postImageBitmaps$_) if (this._$_supportsRvfc$_) {
                    const t = n.c3_imageBitmap;
                    n.c3_imageBitmap = null, o.imageBitmap = t, t && i.push(t);
                } else e.push(createImageBitmap(n).then((t => {
                    o.imageBitmap = t, i.push(t);
                })).catch((t => {
                    o.imageBitmap = null;
                })));
                t[s.toString()] = o;
    ...
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_(j);
}

{
    const N = "mouse", $ = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, N), this._$AddRuntimeMessageHandlers$_([ [ "cursor", t => this._$_OnChangeCursorStyle$_(t) ], [ "request-pointer-lock", t => this._$_OnRequestPointerLock$_(t) ], [ "release-pointer-lock", () => this._$_OnReleasePointerLock$_() ] ]), 
    ...
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_($);
}

{
    const z = "platform-info";
    function q(t) {
        return new Promise(((s, i) => {
            t.getInsetTop(s, i);
        }));
    ...
    const K = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, z), this._$AddRuntimeMessageHandlers$_([ [ "get-initial-state", () => this._$_OnGetInitialState$_() ], [ "request-wake-lock", () => this._$_OnRequestWakeLock$_() ], [ "release-wake-lock", () => this._$_OnReleaseWakeLock$_() ] ]), 
        ...
        async _$_GetSafeAreaInset$_() {
            ...
            if (!t) {
                const t = document.body, s = t.style;
                s.setProperty("--temp-sai-top", "env(safe-area-inset-top)"), s.setProperty("--temp-sai-right", "env(safe-area-inset-right)"), 
                s.setProperty("--temp-sai-bottom", "env(safe-area-inset-bottom)"), s.setProperty("--temp-sai-left", "env(safe-area-inset-left)");
                const i = getComputedStyle(t), e = [ i.getPropertyValue("--temp-sai-top"), i.getPropertyValue("--temp-sai-right"), i.getPropertyValue("--temp-sai-bottom"), i.getPropertyValue("--temp-sai-left") ].map((t => {
                    const s = parseInt(t, 10);
                    return isFinite(s) ? s : 0;
                }));
                return s.removeProperty("--temp-sai-top"), s.removeProperty("--temp-sai-right"), 
                s.removeProperty("--temp-sai-bottom"), s.removeProperty("--temp-sai-left"), e;
            }
            try {
                return await Promise.all([ q(t), Y(t), X(t), J(t) ]);
            } catch (t) {
        ...
        async _$_OnRequestWakeLock$_() {
            if (!this._$_screenWakeLock$_) try {
                this._$_screenWakeLock$_ = await navigator.wakeLock.request("screen"), this._$_screenWakeLock$_.addEventListener("release", (() => this._$_OnWakeLockReleased$_())), 
                console.log("[Construct] Screen wake lock acquired"), this._$PostToRuntime$_("wake-lock-acquired");
            } catch (t) {
                console.warn("[Construct] Failed to acquire screen wake lock: ", t), this._$PostToRuntime$_("wake-lock-error");
            }
        }
    ...
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_(K);
}

{
    const Z = 180 / Math.PI, Q = "audio";
    self._$AudioDOMHandler$_ = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, Q), this._$_audioContext$_ = null, this._$_destinationNode$_ = null, this._$_hasUnblocked$_ = !1, 
...

{
    ...
    self._$C3AudioInstance$_ = class {
        constructor(t, s, i) {
            this._$_audioDomHandler$_ = t, this._$_buffer$_ = s, this._$_tags$_ = i, this._$_aiId$_ = tt++, 
...

{
    ...
    self._$C3AudioFilterFX$_ = class extends st {
    ...
    }, self._$C3AudioDelayFX$_ = class extends st {
        constructor(t, s, i, e) {
    ...
    }, self._$C3AudioConvolveFX$_ = class extends st {
        constructor(t, s, i, e) {
    ...
    }, self._$C3AudioFlangerFX$_ = class extends st {
    ...
    }, self._$C3AudioPhaserFX$_ = class extends st {
        constructor(t, s, i, e, h, n, o) {
    ...
    }, self._$C3AudioGainFX$_ = class extends st {
        constructor(t, s) {
    ...
    }, self._$C3AudioStereoPanFX$_ = class extends st {
        constructor(t, s) {
    ...
    }, self._$C3AudioTremoloFX$_ = class extends st {
        constructor(t, s, i) {
    ...
    }, self._$C3AudioRingModFX$_ = class extends st {
        constructor(t, s, i) {
    ...
    }, self._$C3AudioDistortionFX$_ = class extends st {
        constructor(t, s, i, e, h, n) {
    ...
    }, self._$C3AudioCompressorFX$_ = class extends st {
        constructor(t, s, i, e, h, n) {
        ...
        _$SetParam$_(t, s, i, e) {}
    }, self._$C3AudioAnalyserFX$_ = class extends st {
        constructor(t, s, i) {
...

{
    ...
    const ht = class extends self._$DOMElementHandler$_ {
        constructor(t) {
            super(t, it);
        }
        _$CreateElement$_(t, s) {
            ...
            i.style.webkitUserSelect = "none", i.addEventListener("pointerdown", et), i.addEventListener("pointerrawupdate", et), 
            i.addEventListener("pointerup", et), i.addEventListener("mousedown", et), i.addEventListener("mouseup", et), 
            i.addEventListener("keydown", et), i.addEventListener("keyup", et), i.addEventListener("contextmenu", (t => t.preventDefault())), 
            ...
            i.addEventListener("change", (() => this._$PostToRuntimeElement$_("change", t, {
                ...
                value: parseFloat(i.value)
            }))), s.id && (i.id = s.id), s.className && (i.className = s.className), this._$UpdateState$_(i, s), 
            i;
        }
        _$UpdateState$_(t, s) {
    ...
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_(ht);
}

{
    const nt = "keyboard", ot = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, nt), this._$_isKeyboardLockSupported$_ = !(!navigator.keyboard || !navigator.keyboard.lock), 
    ...
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_(ot);
}

{
    ...
    const lt = class extends self._$DOMElementHandler$_ {
        constructor(t) {
            super(t, rt), this._$AddDOMElementMessageHandler$_("scroll-to-bottom", (t => this._$_OnScrollToBottom$_(t)));
        }
        _$CreateElement$_(t, s) {
            let i;
            const e = s.type;
            return "textarea" === e ? (i = document.createElement("textarea"), i.style.resize = "none") : (i = document.createElement("input"), 
            i.type = e), i.style.position = "absolute", i.autocomplete = "off", i.addEventListener("pointerdown", at), 
            i.addEventListener("pointerrawupdate", at), i.addEventListener("pointerup", at), 
            i.addEventListener("mousedown", at), i.addEventListener("mouseup", at), i.addEventListener("keydown", ct), 
            i.addEventListener("keyup", ct), i.addEventListener("click", (s => {
                s.stopPropagation(), this._$_PostToRuntimeElementMaybeSync$_("click", t);
            })), i.addEventListener("dblclick", (s => {
                s.stopPropagation(), this._$_PostToRuntimeElementMaybeSync$_("dblclick", t);
            })), i.addEventListener("input", (() => this._$PostToRuntimeElement$_("change", t, {
                text: i.value
            }))), s.id && (i.id = s.id), s.className && (i.className = s.className), this._$UpdateState$_(i, s), 
            i;
        }
        _$UpdateState$_(t, s) {
            t.value = s.text, t.placeholder = s.placeholder, t.title = s.title, t.disabled = !s.isEnabled, 
            t.readOnly = s.isReadOnly, t.spellcheck = s.spellCheck;
            const i = s.maxLength;
    ...
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_(lt);
}
